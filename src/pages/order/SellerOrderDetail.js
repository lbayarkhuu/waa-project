                    ...
                    <div className="text-gray-700">
                        <div className="grid md:grid-cols-2 text-sm">
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <label className="px-4 py-2 border rounded-md focus:border-blue-500 focus:outline-none focus:ring">{order.user.name}</label>
                            </div>
                            <div className="grid grid-cols-2">
            ...
            <div className="container px-5 mx-auto">
                <div className="bg-white p-3 shadow-sm rounded-sm">
                    <div className="flex items-center justify-center mt-4">
                        ...
                        {(order.status === "ACTIVE" || order.status === "SHIPPING") &&
                            <button
                                className="px-4 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded hover:bg-gray-600 focus:outline-none"
